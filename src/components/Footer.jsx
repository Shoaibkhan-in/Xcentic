                    ...
                    <div className="container px-6 mx-auto space-y-6 divide-y  md:space-y-12 divide-opacity-50">
                        ...
                        <div className="grid justify-center pt-6 lg:justify-between">
                            <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
                                <span>©2024 <span className='text-blue-500'>XCENTIC</span>. All rights reserved.</span>
                            </div>
                            <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                                <Link to="/" title="LinkdIn" className="flex items-center justify-center  rounded-full">
                                    <ImLinkedin2 className='text-blue-500 w-7 h-7' />
                                </Link>
                                <Link to="/" title="Facebook" className="flex items-center justify-center  rounded-full">
