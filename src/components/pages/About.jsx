...
import xcentica from '../images/favicon.png'
const About = () => {
                ...
                <div className="container mx-auto px-10">
                    <div className="flex flex-wrap items-center -mx-4">
                        <motion.div
                            ...
                            Trusted by Over 500 Clients. Our digital marketing and development services have helped
                            over 500 businesses achieve online success, delivering results in more than 1,000 projects.
                            </p>
                        </motion.div>
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-7/12 ">
                            <motion.div
                                ...
                                <p className="mb-8 text-base text-gray-500">
                                    At XCENTIC, we are passionate about crafting exceptional web solutions that drive digital success.
                                    ...
                                    Whether youre a startup looking to establish a web presence or an established enterprise seeking to expand,
                                    we are here to empower your digital journey. Join us, and lets transform your web vision into reality.
                                </p>
                                <a
                                    href="/#"
                    ...
                    <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
                        <motion.div
                            ...
                            <div className="flex-1 my-4">
                                <p className="text-xl font-semibold leadi">Apoorv Sharma</p>
                                <p>President</p>
                                <p>Founder</p>
                            </div>
